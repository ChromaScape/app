...
import {Text,View, StyleSheet, Pressable, Modal, Button, TextInput} from "react-native";
...
const DeviceP = () => {
    ...
    return (
      ...
      />
        ...
        <Pressable onPress ={() => router.push ("/viewConfiguration")} style={styles.optionsBlock}>
          <View style={styles.optionBlockContainer}>
        ...
        <Pressable onPress ={() => router.push ("/configuration")} style={styles.optionsBlock}>
          <View style={styles.optionBlockContainer}>
            <Text style={styles.optionsText}>Change LED configuration</Text>
            <FontAwesome name="chevron-right" size={15} color="#777B7E" style={styles.icon3}/>
          </View>
        </Pressable>
        <Pressable onPress ={() => router.push ("/changeLEDPatterns")} style={styles.optionsBlock}>
          <View style={styles.optionBlockContainer}>
            <Text style={styles.optionsText}>Change LED patterns</Text>
            <FontAwesome name="chevron-right" size={15} color="#777B7E" style={styles.icon4}/>
          </View>
        </Pressable>
        <Pressable onPress ={() => router.push ("/changeLEDPatterns")} style={styles.optionsBlock}>
          <View style={styles.optionBlockContainer}>
