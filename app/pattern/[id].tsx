...
const PatternP = () => {
    ...
    return (
      ...
      />
        ...
        <Pressable onPress ={() => router.push ("/schedulingInterface")} style={styles.optionsBlock}>
          <View style={styles.optionBlockContainer}>
            <Text style={styles.optionsText}>Scheduling</Text>
            <FontAwesome name="chevron-right" size={15} color="#777B7E" style={styles.icon2}/>
          </View>
        </Pressable>
        <Pressable onPress ={() => router.push ("/changeConfiguration")} style={styles.optionsBlock}>
          <View style={styles.optionBlockContainer}>
